...
namespace VISION.Cogs
{
    public class Line
    {
        ...
        public void Area1(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        public void Area2(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        public void Area3(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        public void Area4(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        public void Area5(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        public void Area6(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        public void Area7(ref Cognex.VisionPro.Display.CogDisplay Display, Cognex.VisionPro.CogImage8Grey Image, string ImageSpace)
        {
            if (InputImage(Image) == true)
            {
                ImageSpace = $"MultiPattern - {ImageSpace}";
        ...
        {
            int Toolnumber;
            string spacename = Tool.RunParams.ExpectedLineSegment.SelectedSpaceName;
        ...
        public void ResultDisplay(Cognex.VisionPro.Display.CogDisplay display, Cognex.VisionPro.CogGraphicCollection Collection)
        {
            try
            {
                ...
                if (/*Tool.Results.Count != */Tool.Results.NumPointsFound == 0)
                {
                    return;
                }
                if (Tool.Results.RMSError == null)
                {
                    return;
                }
                Collection.Add(Tool.Results.GetLine());
        ...
        public void ToolSetupResultDisplay(Cognex.VisionPro.Display.CogDisplay display, Cognex.VisionPro.CogGraphicCollection Collection)
        {
            try
            {
                if (this.Tool.Results == null)
                ...
                if (Tool.Results.NumPointsFound == 0)
                {
                    return;
                }
                if (Tool.Results.RMSError == null)
