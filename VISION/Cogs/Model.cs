...
namespace VISION.Cogs
{
    public class Model
    {
        ...
        private int[,] LineFixPatternNumber = new int[Program.CameraList.Count(), BLOBTOOLMAX];
        ...
        { // 초기화
            ...
            for (int i = 0; i < Program.CameraList.Count(); i++)
            {
                ...
                for (int lop = 0; lop < CaliperMax; lop++)
                {
        ...
        private bool Read(string path, int cam)
        {
            ...
            for (int lop = 0; lop <= LineMax; lop++)
            {
                ...
                LineFixPatternNumber[cam, lop] = Convert.ToInt32(Modelcfg.ReadData("LINE - " + lop.ToString(), "LineFixPatternNumber"));
            }
            for (int lop = 0; lop < CircleMax; lop++)
            {
        ...
        public bool SaveModel(string path, int cam)
        {
            ...
            for (int lop = 0; lop <= LineMax; lop++)
            {
                ...
                Modelcfg.WriteData("LINE - " + lop.ToString(), "LineFixPatternNumber", LineFixPatternNumber[cam, lop].ToString());
            }
        ...
        public void Caliper(Caliper[,] Caliper)
        {
            Calipers = Caliper;
        }
        ...
        public int[,] LineFixPatternNumbers()
        {
            return LineFixPatternNumber;
        }

        public void LineFixPatternNumbers(int[,] PatternNumber)
        {
            LineFixPatternNumber = PatternNumber;
        }
        ...
        public bool Caliper_Inspection(ref Cognex.VisionPro.Display.CogDisplay Display, CogImage8Grey Image, ref string[] ResultString, int CamNumber, CogGraphicCollection Collection)
        {
            try
            {
                bool Result = true;
                ...
                for (int lop = 1; lop <= CaliperMax; lop++)
                {
                    if (CaliperEnable[CamNumber, lop] == true)
                    {
                        Calipers[CamNumber, lop].ResultDisplay(ref Display);
                    }
                }
        ...
        public CogImage8Grey Blob_FixtureImage7(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage1(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage2(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage3(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage4(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage5(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage6(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
        ...
        public CogImage8Grey LINE_FixtureImage7(CogImage8Grey OriImage, CogTransform2DLinear Fixtured, string SetName, int Camnumber, int toolnumber, out string ImageSpacename, int HighPatternNumber)
        {
            Cognex.VisionPro.CalibFix.CogFixtureTool Fixture = new Cognex.VisionPro.CalibFix.CogFixtureTool();
